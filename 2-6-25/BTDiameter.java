...
class Solution {
    ...
    public int diametero(TreeNode root, int c)
    {
        if(root==null)
        {
            return c;
        ...
        int l=diametero(root.left,c+1);
        int r=diametero(root.right,c+1);
    ...
    public int diameterOfBinaryTree(TreeNode root) {
       ...
       int l=diametero(root.left,0);
       int r=diametero(root.right,0);
