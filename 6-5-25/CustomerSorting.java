...
public class CustomerSorting {
    public static void main(String[] args) {
        ...
        //WRITE YOUR CODE HERE
        byNameBill.sort(Comparator.comparing(Customer::getName).thenComparing(Customer::getBill));
        ...
        //WRITE YOUR CODE HERE
        byIdBill.sort(Comparator.comparing(Customer::getId).thenComparing(Comparator.comparingDouble(Customer::getBill)));
		...
		//WRITE YOUR CODE HERE
		byBillAscName.sort(Comparator.comparing(Customer::getBill).thenComparing(Customer::getName));
		...
		//WRITE YOUR CODE HERE
		byBillDescName.sort(Comparator.comparing(Customer::getBill).thenComparing(Customer::getName));
